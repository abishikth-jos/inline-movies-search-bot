...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ['ADMINS', 1416381241].split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ['CHANNELS','-1001394559471'].split()]
